    ...
    <GuestLayout>
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
            <div class="h-32 md:h-auto md:w-1/2">
                <img aria-hidden="true" class="object-cover w-full h-full" src="/images/create-account-office.jpg"
                    alt="Office" />
            </div>
                ...
                <div class="w-full">
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="mt-4">
                            ...
                            <TextInput id="username" type="text" class="block w-full mt-1" v-model="form.username" required
